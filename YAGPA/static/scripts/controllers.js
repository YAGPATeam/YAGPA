...
yagpa.controller('playerCtrl', ['$scope', '$http', function($scope, $http) {
	$scope.data = [{'agaExpirationDate': '','agaId':'','club':'56Lo','country':'FR','egfPin':'','ffgLicence':'','ffgLicenceStatus':'','firstName':'Damien','grade':'13K','name':'le_Goff','participating':'11111111111111111111','rank':'13K','rating':'800','ratingOrigin':'INI','registeringStatus':'FIN','smmsCorrection':'0'},
